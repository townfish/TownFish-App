...
namespace TownFish.App.Pages
{
    public partial class BrowserPage : ContentPage
    {
        ...
        protected override void OnBindingContextChanged()
        {
            ...
            ViewModel.DiscoveryItems = new ObservableRangeCollection<DiscoveryItemViewModel>();
...
#pragma warning disable IDE1006 // Naming Styles ("lst" is Hungarian Notation prefix used for XAML controls)
        ...
        public async void lstDiscoveries_ItemTapped(object sender, ItemTappedEventArgs e)
        {
            // when using ListView:
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        void UpdateDiscoveryItems()
        {
            ...
            ViewModel.DiscoveryItems.Clear();

            // if no items, kill previous list
            if (count == 0)
                return;

            ViewModel.DiscoveryItems.AddRange(discoveryItems);
        }
        ...
        void ShowDiscoveries()
        {
            ...
            {
                if (!ViewModel.IsDiscoveriesVisible || !ViewModel.DiscoveryItems.Any())
                    return false;
		...
		async Task HideDiscoveriesAsync (bool showLoading = true)
		{
            if (ViewModel.IsDiscoveriesVisible && !mHidingDiscoveries)
            {
                ...
                ViewModel.DiscoveryItems.Clear(); // side-effect: updates visibility properties!
