...
namespace TownFish.App.Helpers
{
	public class ImageSourceWatcher
	{
		...
		public static readonly BindableProperty ImageLoadedHandlerProperty =
			//BindableProperty.CreateAttached ("ImageLoader", typeof (EventHandler<bool>),
		...
		public static EventHandler<bool> GetImageLoadedHandler (BindableObject bo) =>
			(EventHandler<bool>) bo.GetValue (ImageLoadedHandlerProperty);

		public static void SetImageLoadedHandler (BindableObject bo, EventHandler<bool> value)
		{
